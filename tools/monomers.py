                ...
                if not combined_df.empty:
                    ...
                    if user_min_val >= user_max_val:
                        ...
                        if thresholding_method == "Automatic (Mu/Sigma)":
                            ...
                            threshold1 = st.number_input("Threshold 1", min_value=user_min_val, max_value=user_max_val, value=(user_max_val + user_min_val) / 2)
                            threshold2 = st.number_input("Threshold 2", min_value=user_min_val, max_value=user_max_val, value=user_max_val * 0.75)
                            threshold3 = st.number_input("Threshold 3", min_value=user_min_val, max_value=user_max_val, value=user_max_val * 0.9)
                        ...
                        if thresholds:
                            ...
                            with plot_col1:
                                ...
                                labels_for_pie = base_labels[:num_bins] if num_bins <= len(base_labels) else base_labels + [f"Group {i+1}" for i in range(len(base_labels), num_bins)]
